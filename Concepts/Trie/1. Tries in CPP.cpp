...
// issue with delete as free_trienode is working fine but references are not updating properly.
...
int main(){
    ...
    insertWord(root, "appy");
    insertWord(root, "apply");
    insertWord("boards");
    insertWord("board");
    cout<<searchWord(root, "apply");


    deleteWord("boards");
    
    cout<<"After Delete"<<endl;
    cout<<searchWord("boards") << endl;
